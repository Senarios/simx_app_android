...
public class PaymentsUtil {
    ...
    private static JSONObject getDirectTokenizationSpecification()
        ...
        JSONObject parameters = new JSONObject(GooglePayConstants.DIRECT_TOKENIZATION_PARAMETERS);
     ...
     */
    @RequiresApi(api = Build.VERSION_CODES.N)
    public static PaymentDataRequest getPaymentDataRequest(String price) {
      ...
      JSON object. */
            ...
            JSONArray allowedCountryCodes = new JSONArray(GooglePayConstants.SHIPPING_SUPPORTED_COUNTRIES);
